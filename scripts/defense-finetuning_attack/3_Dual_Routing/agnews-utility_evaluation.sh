...
poison_ratio_names=(agnews_tuning_p_0 agnews_tuning_p_0.1) #  agnews_tuning_p_0 agnews_tuning_p_0.1 agnews_tuning_p_0.2

for i in ${!poison_ratio_names[@]}; do
    poison_ratio_name=${poison_ratio_names[$i]}

    ## ------------- agnews --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    CUDA_VISIBLE_DEVICES=4,5 python TriShield/gen_model_answer-tri_shield.py \
        --model_name qwen3 \
        --model_path /media/1/public_model/Qwen3-8B \
        --lora_path finetuning/finetuned_models/${poison_ratio_name} \
        --data_paths finetuning/evaluation/utility_evaluation/agnews/agnew_test_data.json \
        --batch_size 1 \
        --gen_batch_size 64 \
        --data_mode test \
        --data_source agnews \
